...
function setPage(page) {
    ...
    else if (page === "phd-cs" || page === "cs" || page === "phd") renderPhdCSModule(APP_DATA.phdCS);
    else if (page === "phd-management" || page === "management" || page === "mgmt") renderPhdManagementModule(APP_DATA.phdManagement);
    else if (page === "applications" || page === "application") renderApplicationsModule();
    else if (page === "interviews" || page === "interview") renderInterviewsModule();
    else if (page === "companies" || page === "company") renderCompaniesModule();
    else if (page === "tasks" || page === "task") renderTasksModule();
    else if (page === "calendar") renderCalendarModule();
    else if (page === "analytics") renderAnalyticsModule();
    else if (page === "settings") renderSettingsModule();
